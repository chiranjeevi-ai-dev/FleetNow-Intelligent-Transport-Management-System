    ...
    for row in data:
        ...
        for col in columns:
            ...
            if isinstance(value, ObjectId):
                ...
                csv_row[col] = value.isoformat() if value else ''
            else:
                csv_row[col] = value
    ...
    try:
        ...
        for expense in expenses:
            ...
            expense_info = {
                ...
                'amount': amount,
                'expense_date': expense.get('expense_date').isoformat() if expense.get('expense_date') else None,
